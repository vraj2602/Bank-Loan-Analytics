...
The Bank Loan Analytics Dashboard provides an integrated view of loan applications, funded amounts, repayments, interest rates, borrower characteristics, and loan risk distribution.
It enables banking teams, credit analysts, managers, and decision-makers to monitor financial performance, evaluate lending risk, and support data-driven strategy development.
...
•	Issue date for time-series analysis
Data was cleaned, validated, transformed, and structured for accurate KPI reporting and dashboard automation.
...
2. State-Level Loan Activity (Filled Map)
